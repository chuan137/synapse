...
**Logging milestones to S-Deck:**
Use `send_message(to_id="human", priority=5)` to log key decisions — not questions, just visibility.
Example: `"Spawned 3 workers for backend/frontend/infra review"`
